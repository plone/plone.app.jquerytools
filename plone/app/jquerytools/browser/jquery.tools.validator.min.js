...
function(a,b){return b===""||(new RegExp("^"+a.attr("pattern")+"$")).test(b)});i.fn(":radio[required]","Please select an option.",function(a){var b=false;e("[name='"+a.attr("name")+"']").each(function(c,j){if(e(j).is(":checked")||b)b=true});return b?true:false});e.fn.validator=function(a){var b=this.data("validator");if(b){b.destroy();this.removeData("validator")}a=e.extend(true,{},i.conf,a);if(this.is("form"))return this.each(function(){var c=e(this);b=new u(c.find(":input"),c,a);c.data("validator",b)});else{b=
